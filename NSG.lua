...
local realchar = game.Workspace:FindFirstChild(game.Players.LocalPlayer.Name, true)
pcall(function()
for i,v in pairs(realchar:GetChildren()) do
	if v:IsA("Accessory") and v.Handle.Size == Vector3.new(1,1,2) then
...
return function(tabss)
local ins = Instance.new(ins)
for i,v in pairs(tabss) do
	ins[i] = v
end
return ins 
end
...
xpcall(function()
local hat = char["Evil Aura"].Handle
...
weld.C0 = CFrame.Angles(math.rad(-5),0,0)
end,warn)
...
xpcall(function()
local hat = char["Pal Hair"].Handle
hat.AccessoryWeld:Destroy()
local weld = Instance.new("Weld", handle)
weld.Part0 = lwing1
weld.Part1 = hat
...
xpcall(function()
local hat = char["Pink Hair"].Handle
hat.AccessoryWeld:Destroy()
local weld = Instance.new("Weld", handle)
weld.Part0 = lwing2
weld.Part1 = hat
...
xpcall(function()
local hat = char["LavanderHair"].Handle
hat.AccessoryWeld:Destroy()
local weld = Instance.new("Weld", handle)
weld.Part0 = lwing3
weld.Part1 = hat
...
xpcall(function()
local hat = char["Kate Hair"].Handle
hat.AccessoryWeld:Destroy()
local weld = Instance.new("Weld", handle)
weld.Part0 = rwing1
weld.Part1 = hat
...
xpcall(function()
local hat = char["Robloxclassicred"].Handle
hat.AccessoryWeld:Destroy()
local weld = Instance.new("Weld", handle)
weld.Part0 = rwing3
weld.Part1 = hat
...
--if not targetted.Parent:FindFirstChild("Head") then return end
attack = true
...
sphere(3,"Add",root.CFrame,vt(0,0,0),0.25,BrickColor.new("Really black"))
pcall(function() bld.Enabled = false end)
attack = false
...
mouse.KeyDown:connect(function(k)
	if(k == "w" or k == "a" or k == "s" or k == "d")then
		...
		if(input == "wwssadad" and not AllowSomeone)then
			AllowSomeone = true
			warn("Someone unlocked! Have fun ;)")
...
RW.C0=clerp(RW.C0,cf(0.75,0.5,-0.25)*angles(math.rad(140),math.rad(0),math.rad(-20 + 2.5 * math.cos(sine / 28))),.1)
LW.C0=clerp(LW.C0,cf(-0.75,0.5,-0.25)*angles(math.rad(140),math.rad(0),math.rad(20 - 2.5 * math.cos(sine / 28))),.1)
until kan.TimePosition > 7.25 + 0.55
CameraEnshaking(1,1)
...
if k == "m" and attack == false and ModeOfGlitch == 69 and AllowSomeone then
thingthing()()
end
end)
coroutine.resume(coroutine.create(function()
