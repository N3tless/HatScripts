local CMouse = {GetPlayer = function()
					return game.Players.LocalPlayer
				end
				}
CMouse.__index = game.Players.LocalPlayer:GetMouse()
...
for i,v in pairs(mas:GetChildren()) do
	v.Parent = CMouse:GetPlayer().Character
...
if hat then
	local swordweld = Instance.new("Weld", hat)
	hat.Handle.AccessoryWeld:Destroy()
	--hat.Handle.SpecialMesh:Destroy()
	swordweld.Part1 = hat.Handle
	swordweld.C0  = CFrame.Angles(0,0,math.rad(-45)) * CFrame.new(-2,-2,0)
	swordweld.Part0 = rarmor
end
