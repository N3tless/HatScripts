...
local script = game:GetObjects("rbxassetid://5813775563")[1].Carnage
...
local snip = Character:FindFirstChild("Meshes/SniperAccessory")
if not snip then
snip = AddAccessory(5134896593)
snip.Parent = game.Lighting
end

snip.Handle.AccessoryWeld:Destroy()
local snipweld = Instance.new("Weld", snip.Handle)
snipweld.Part0 = gun.Handle
snipweld.Part1 = snip.Handle
snipweld.C0 = CFrame.Angles(0,0,math.rad(0)) * CFrame.Angles(math.rad(-50),math.rad(-90),math.rad(0)) * CFrame.new(-0.25,1.25,0)
local hole = gun.Hole
...
local shot2 = Character:FindFirstChild("Red Sci-Fi Scattergun")
if not shot2 then
shot2 = AddAccessory(5134896593)
shot2.Parent = game.Lighting
end
local shotweld = Instance.new("Weld", shot2)
shotweld.Part0 = shotgun.Main
shotweld.Part1 = shot2.Handle
shotweld.C0 = CFrame.Angles(math.rad(-75),math.rad(-90),math.rad(45)) * CFrame.new(-0.25,0.5,0)
shot2.Handle.AccessoryWeld:Destroy()
...
shotweld.Part0 = fshot.Main
shotweld.C0 = CFrame.new(0,0,0.75) * CFrame.Angles(0,0,math.rad(-95))
...
snipweld.Part0 = Character.Torso
snipweld.Part1 = snip.Handle
snipweld.C0 = CFrame.new(0,0,0.75) * CFrame.Angles(math.rad(-0),math.rad(-180),math.rad(15))
...
if NullwareAPI then
	NullwareFling(sp.Position, 0.75)
end
for i = 1,15 do
...
if NullwareAPI then
	NullwareFling(sp1.Position, 0.75)
end
sp1:Destroy()
sp2:Destroy()
stuck = true
...
if NullwareAPI then
	NullwareFling(ab.Position, 0.75)
end
swait(.1)
end
end		
